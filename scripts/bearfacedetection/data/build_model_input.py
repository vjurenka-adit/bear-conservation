...
import bearfacedetection.build_model_input as build_model_input
...
def make_cli_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="./data/04_features/golden_dataset/",
        required=True,
    )
    parser.add_argument(
        "--to",
        ...
        required=True,
        default="./data/05_model_input/bearfacedetection/golden_dataset/",
    )
    parser.add_argument(
        "-log",
        "--loglevel",
