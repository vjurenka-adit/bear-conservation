...
from bearfacesegmentation.sam_hq.segment_body import load_sam_predictor, run
...
def make_cli_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="./data/06_models/bearfacesegmentation/sam-hq/weights/sam_hq_vit_h.pth",
    )
    parser.add_argument(
        "--bearid-base-path",
...
if __name__ == "__main__":
    ...
    if not validate_parsed_args(args):
        ...
        print(args)
        logging.info("Loading the SAM HQ model")
